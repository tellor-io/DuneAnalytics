...
daily_active_miners as (
SELECT date_trunc('day', block_time) as day, count(distinct miner_address) as miners
FROM miner_rewards
GROUP BY 1
ORDER BY 1 DESC)

select daily_active_miners.day, 
       daily_active_miners.miners as daily_active_miners 
from daily_active_miners
ORDER BY 1 DESC
